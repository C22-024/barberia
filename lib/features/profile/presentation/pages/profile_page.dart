...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final initialName = user.email.substring(0, 1);
    return BlocProvider(
      create: (context) =>
            ...
            Column(
              ...
              children: [
                BListTile(
                  ...
                  prefix: BlocBuilder<GetProfilePictureBloc, GetProfilePictureState>(
                    builder: (context, state) {
                      return CircleAvatar(
                        ...
                        child: state.maybeWhen(
                          failure: (failure) => const Icon(Icons.image_not_supported_rounded),
                          success: (profilePictureData) {
                            if (profilePictureData == null) {
                              return BText(
                                initialName,
                  ...
                  title: Padding(
                    ...
                    child: BText.highlightMedium(user.name.toString()),
                  ),
                  subtitle: Padding(
                    padding: const EdgeInsets.only(left: 16),
