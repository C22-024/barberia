...
mixin _$AppointmentModel {
  ...
  Map<dynamic, dynamic> get status => throw _privateConstructorUsedError;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      barbershop: null == barbershop
          ? _value.barbershop
          : barbershop // ignore: cast_nullable_to_non_nullable
              as Map<dynamic, dynamic>,
      services: freezed == services
          ? _value.services
          : services // ignore: cast_nullable_to_non_nullable
              as List<Map>?,
      userDefinedExpiry: freezed == userDefinedExpiry
...
class _$_AppointmentModel extends _AppointmentModel {
  const _$_AppointmentModel(
      ...
      required final Map<dynamic, dynamic> status,
      required final Map<dynamic, dynamic> user,
  ...
  @JsonKey(ignore: true)
  final String? id;
  final Map<dynamic, dynamic> _status;
  @override
  Map<dynamic, dynamic> get status {
  ...
  final Map<dynamic, dynamic> _barbershop;
  @override
  Map<dynamic, dynamic> get barbershop {
    if (_barbershop is EqualUnmodifiableMapView) return _barbershop;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_barbershop);
  }
  ...
  final Map<dynamic, dynamic>? _review;
  @override
  Map<dynamic, dynamic>? get review {
    final value = _review;
    if (value == null) return null;
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._barbershop, _barbershop) &&
